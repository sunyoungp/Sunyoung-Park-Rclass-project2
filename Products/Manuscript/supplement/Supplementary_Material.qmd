...
resulttable1 = readRDS("../../Results/mass_island_species_anova.rds"))
knitr::kable(resulttable1, digits=2)
```



@fig-result2 shows a density plot produced by one of the R scripts. (Just for illustrative purposes, this does not add anything to the exlaination of the analysis, really.)


```{r}
#| label: fig-result2
#| fig-cap: "Mass by species."
#| echo: FALSE
knitr::include_graphics("../../Results/mass_species_density.png"))
```
